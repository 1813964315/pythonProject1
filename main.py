...
suanfaMenu.add_command(label="动态规划", command=select_datafile, background='pink')
suanfaMenu.add_command(label="贪心算法", command=select_datafile, background='pink')
suanfaMenu.add_command(label="回溯算法", command=select_datafile, background='pink')
suanfaMenu.add_command(label="遗传算法", command=select_datafile, background='pink')
shujuMenu.add_command(label="选择文件", command=openfile, background='pink')
pictureMenu.add_command(label="散点图", command=select_datafile, background='pink')
pictureMenu.add_command(label="柱状图", command=select_datafile, background='pink')
sortMenu.add_command(label="递增排序", command=select_datafile, background='pink')
sortMenu.add_command(label="递减排序", command=select_datafile, background='pink')
